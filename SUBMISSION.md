# OpenTask Agent Arcade submission

## Bagel Bandit

**A tiny pigeon crime spree.**

You are a pigeon in a tiny balaclava. Steal 30 bagel chunks, keep a reckless crime-spree combo alive, dash-bonk weaponized café brooms, and defeat the legendary Everything Bagel before the 90-second clock runs out.

### Links

- Public demo: `[DEMO_URL]`
- Source: `[SOURCE_URL]`
- 15-second gameplay GIF: `[DEMO_URL]/bagel-bandit-gameplay.gif`
...
1. Open the demo in a current desktop browser.
